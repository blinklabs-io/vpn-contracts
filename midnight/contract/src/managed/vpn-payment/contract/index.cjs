...
class Contract {
      ...
      payForVPN: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.originalState != undefined && contextOrig_0.transactionContext != undefined)) {
          __compactRuntime.type_error('payForVPN',
                                      ...
                                      'vpn-payment.compact line 110 char 1',
                                      'CircuitContext',
                                      contextOrig_0)
        }
      ...
      verifyPaymentExists: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.originalState != undefined && contextOrig_0.transactionContext != undefined)) {
          __compactRuntime.type_error('verifyPaymentExists',
                                      'argument 1 (as invoked from Typescript)',
                                      'vpn-payment.compact line 149 char 1',
                                      'CircuitContext',
                                      contextOrig_0)
        }
      ...
      updateProvider: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.originalState != undefined && contextOrig_0.transactionContext != undefined)) {
          __compactRuntime.type_error('updateProvider',
                                      'argument 1 (as invoked from Typescript)',
                                      'vpn-payment.compact line 158 char 1',
                                      'CircuitContext',
                                      contextOrig_0)
        }
  ...
  _generateNullifier_0(secretKey_0, seq_0, tierIndex_0) {
    return this._persistentHash_0([secretKey_0, seq_0, tierIndex_0]);
  }
                        ...
                        timestamp:
                          ((t1) => {
                            if (t1 > 18446744073709551615n) {
                              throw new __compactRuntime.CompactError('vpn-payment.compact line 135 char 25: cast from field value to Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                            }
                            return t1;
                          })(_descriptor_2.fromValue(Contract._query(context,
                                                                     partialProofData,
  ...
  _verifyPaymentExists_0(context, partialProofData, expectedNullifier_0) {
    return ((t1) => {
             if (t1 > 18446744073709551615n) {
               throw new __compactRuntime.CompactError('vpn-payment.compact line 154 char 10: cast from field value to Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
             }
             return t1;
           })(_descriptor_2.fromValue(Contract._query(context,
                                                      partialProofData,
  ...
  generateNullifier: (...args_0) => {
    ...
    if (!(secretKey_0.buffer instanceof ArrayBuffer && secretKey_0.BYTES_PER_ELEMENT === 1 && secretKey_0.length === 32)) {
      __compactRuntime.type_error('generateNullifier',
                                  'argument 1',
                                  'vpn-payment.compact line 89 char 1',
                                  'Bytes<32>',
                                  secretKey_0)
    }
  ...
  commitmentHash: (...args_0) => {
    ...
    if (!(data_0.buffer instanceof ArrayBuffer && data_0.BYTES_PER_ELEMENT === 1 && data_0.length === 32)) {
      __compactRuntime.type_error('commitmentHash',
                                  'argument 1',
                                  'vpn-payment.compact line 99 char 1',
                                  'Bytes<32>',
                                  data_0)
    }
